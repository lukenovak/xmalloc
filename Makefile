...
collatz-list-par: list_main.o par_malloc.o bktarena.o bktnode.o slabmalloc.o
	gcc $(CFLAGS) -o $@ $^ $(LDLIBS)

collatz-ivec-par: ivec_main.o par_malloc.o bktarena.o bktnode.o slabmalloc.o
	gcc $(CFLAGS) -o $@ $^ $(LDLIBS)
